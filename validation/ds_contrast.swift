...
// Contrast pairs) are PARSED out of Sources/Qnet/DesignSystem.swift at run
...
let designSystemPath = URL(fileURLWithPath: #filePath)
    ...
    .appendingPathComponent("Sources/Qnet/DesignSystem.swift")
...
print("ds_contrast: tokens parsed from Sources/Qnet/DesignSystem.swift")
...
if failures.isEmpty {
    ...
    print("failing token itself, in Sources/Qnet/DesignSystem.swift — this script")
