...
/// bindings.
///
/// `helpTopic:` is the one way a sheet links to documentation. It opens
        ...
        HStack(spacing: DS.Spacing.s) {
            if let helpTopic {
                DSHelpButton(
                    ...
                    help: "Open Qnet Help at \u{201C}\(helpTopic.windowTitle)\u{201D}"
                ) {
                    QnetHelpWindow.show(topic: helpTopic)
                }
                .fixedSize()
            }
