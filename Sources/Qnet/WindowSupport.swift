...
///   • carries an identifier prefixed `qnet.aux.` so File ▸ Close Tab can
...
enum AuxiliaryWindow {
    static let identifierPrefix = "qnet.aux."
...
/// builds shortly after launch; set `QNET_MENU_AUDIT=1` in the environment
...
enum MenuShortcutAudit {
    ...
    static func runAndReport(verbose: Bool) {
        ...
        if ProcessInfo.processInfo.environment["QNET_MENU_AUDIT"] == "1" {
